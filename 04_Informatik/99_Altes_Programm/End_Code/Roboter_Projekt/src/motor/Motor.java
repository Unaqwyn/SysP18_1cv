...
public class Motor
{
	...
	public void  setSpeed(double speed){
		if(speed > 0)
		{
			hightimePWMPlus = (int)((divider*speed / RobotConstants.MAX_SPEED) * RobotConstants.PERIOD_PWM);
			if(hightimePWMPlus > (int)(RobotConstants.PERIOD_PWM*(double)(1/divider)))
			{
				hightimePWMPlus = (int)(RobotConstants.PERIOD_PWM*(double)(1/divider));
			}
			hightimePWMMinus = 0;			
		}else if(speed < 0)
		{
			hightimePWMMinus = (int)((divider*speed / RobotConstants.MAX_SPEED) * RobotConstants.PERIOD_PWM);
			hightimePWMMinus *= (-1);
			if(hightimePWMMinus > (int)(RobotConstants.PERIOD_PWM*(double)(1/divider)))
			{
				hightimePWMMinus = (int)(RobotConstants.PERIOD_PWM*(double)(1/divider));
			}
			hightimePWMPlus = 0;
		}
		else if(speed == 0)
