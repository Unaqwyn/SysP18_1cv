...
public class RobotConstants {
	...
	public static final int VALUE_PLATFORM_LED_RED_MAX_SUM = 2800;
	public static final int VALUE_PLATFORM_LED_RED_MIN_SUM = 600;
	public static final int VALUE_PLATFORM_LED_RED_POSITION_1_TO_2 = 2000;
	public static final int VALUE_PLATFORM_LED_RED_POSITION_5_TO_6 = 2300;
	public static final int VALUE_LED_DOCK_BORDER = 800;
	// Constants for State Machine
	public static final int STATE_MACHINE_TASK_PERIOD = 100;
