 ...
 */
public class speedController4DCMotorCopy {
	 ...
	 */
	public speedController4DCMotorCopy(float ts, int pwmChannel1, int pwmChannel2, boolean useTPUA4PWM, int encChannelA, boolean useTPUA4Enc, int encTPR, float umax, float i, float kp, float tn) {
		// set parameters
	...
	private void setPWM(double dutyCycle) {
		...
		pwmA.update(pwmPeriod, (int)(dutyCycle + 0.5));
