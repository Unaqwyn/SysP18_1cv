...
public class Lift
{
	...
	{
		tilt(false);
		liftingMotor.toPos(RobiConstants.min,60);
	}
	
	public void toGround()
	{
		tilt(false);
		liftingMotor.toPos(RobiConstants.ground,30);
	}

	public void toHeight(double height)
	{
		double h = Definitions.RobiConstants.posLift * height+Definitions.RobiConstants.liftMin;
	...
	{
		return sensoren.threshold(RobiConstants.sensorLego, Sensoren.sensorArm);
	}
